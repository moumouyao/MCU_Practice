...
uint16_t ADC1_val[3] = {0};	//ADC1扫描模式+DMA转移下的值
/**
...
void ADC1_DMA_init(void){
	...
	//开启DMA1的时钟
		...
		DMA_InitStruct.DMA_BufferSize =3;	//传输次数 
	...
	//规则组配置
	ADC_RegularChannelConfig(ADC1, ADC_Channel_5, 1, ADC_SampleTime_239Cycles5);	//烟雾传感器
	ADC_RegularChannelConfig(ADC1, ADC_Channel_11, 2, ADC_SampleTime_239Cycles5);	//光敏电阻
